...
const hourly__hours = document.querySelector("#hourly__hours")
...
async function getWeatherData(lat, lon) {
  ...
  // if toggle value = F
  if (ddlUnits.value === "NI") {
    tempUnit = "fahrenheit";
    windUnit = "mph";
    precipUnit = "inch";
  }

  else if (ddlUnits.value === "F") {
    tempUnit = "farenheit";
    windUnit = "kmh";
    precipUnit = "mm";
  }

  else if (ddlUnits.value === "c") {
    tempUnit = "celsius"
    windUnit = "kmh";
    precipUnit = "mm";
  }
...
function loadCurrentWeather() {
  ...
  pPrecipitation.textContent = `${weatherData.current.precipitation} ${weatherData.current_units.precipitation.replace("inch", "inch")}`;
}
